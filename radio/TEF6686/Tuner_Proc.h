...
extern  int	TunerKeyCode;   //tuner key
extern  int	TunerWorkMode;  //tuner work mode
extern  char  	TunerSubMode;//as loop  tuning step
extern byte SeekSensLevel;
extern byte TunerFlag1;
...
extern int Radio_ScanStepCount;//scan seak step count;


/*function */
extern void Tuner_Para_Init(void);
extern void Tuner_Mode_Proc(void);
extern void Tuner_Update_ProgCnt(byte mode);
