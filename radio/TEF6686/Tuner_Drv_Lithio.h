...
int devTEF668x_Set_Cmd(TEF668x_MODULE module, byte cmd, int len,...);

int devTEF668x_Radio_Tune_To (bool fm, int mode, int frequency );
int devTEF668x_Radio_Get_Quality_Status (bool fm, byte *status);
int devTEF668x_Radio_Get_Quality_Level (bool fm, byte *status,int16_t *level);
int devTEF668x_Radio_Get_Quality_Data (bool fm, byte *usn, byte *wam,int16_t *offset);
int devTEF668x_APPL_Get_Operation_Status(byte *status);
int devTEF668x_APPL_Set_ReferenceClock(int frequency_high, int frequency_low, int type);
int devTEF668x_APPL_Activate(int mode);
int devTEF668x_Audio_Set_Mute(int mode);
int devTEF668x_Audio_Set_Volume(int16_t volume);
int devTEF668x_Radio_Get_Signal_Status(bool fm, int *status);
int devTEF668x_Para_Load(void);
int devTEF668x_Audio_Set_Dig_IO(int signal, int mode, int format, int operation, int samplerate);
int devTEF668x_Audio_Set_Output_Source(int signal, int source);
int devTEF668x_APPL_Set_OperationMode(int mode);
bool devTEF668x_Radio_Is_AF_Update_Available (void);
bool devTEF668x_Radio_Is_RDAV_Available (void);
int devTEF668x_Radio_Get_RDS_DataRaw (bool fm, int *status, unsigned int *raw_data);
int devTEF668x_Radio_Set_ChannelEqualizer(bool fm, int mode);
int devTEF668x_Radio_Set_StereoImprovement(bool fm, int mode);
int devTEF668x_Radio_Set_StHiBlend_Time(bool fm, int slow_attack, int slow_decay, int fast_attack, int fast_decay);
